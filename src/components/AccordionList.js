...
const AccordionList = ({items}) => {
    ...
    return window.innerWidth <= 768 ? (
        <div>
            {
                items.map((item) => (
                    <div className="border-b-2 space-y-2 flex w-[360px] justify-between py-4 mx-2 mx-auto">
                        <div className="space-y-2 w-[220px]">
                            ...
                            <p className="w-[220px] text-[#02060C99] text-sm font-semibold">
                        ...
                        <div className="w-[160px] h-[134px] flex flex-col items-center relative">
                            <img className="w-[146px] h-[144px] rounded-lg absolute" src={IMAGE_CDN + item.card.info.imageId}/>
                            <button className="w-24 h-9 border-2 rounded-lg text-green-500 font-bold box-border bg-white absolute -bottom-5">Add+</button>
...
export default AccordionListimport { IMAGE_CDN } from "../utils/constant"
import { useDispatch } from "react-redux";
import { addItem } from "../redux/cartSlice";
import { useState, useEffect } from "react";
