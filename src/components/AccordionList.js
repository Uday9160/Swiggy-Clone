...
const AccordionList = ({items}) => {
    ...
    return window.innerWidth <= 768 ? (
        <div>
            {
                items.map((item) => (
                    <div className="border-b-2 space-y-2 flex w-[398px] justify-between py-4">
                        <div className="space-y-2 w-[230px]">
                            ...
                            <p className="w-[230px] text-[#02060C99] text-sm font-semibold">
                        ...
                        <div className="w-[160px] h-[144px] flex flex-col items-center relative">
                            <img className="w-[156px] h-[144px] rounded-lg absolute" src={IMAGE_CDN + item.card.info.imageId}/>
